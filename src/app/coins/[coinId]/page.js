...
import { Box, LinearProgress, List, ListItem, ListItemIcon, ListItemText, Paper, Table, TableBody, TableHead, TableRow, Typography } from '@mui/material';
import AttachMoneyIcon from '@mui/icons-material/AttachMoney';
import ArrowDownwardIcon from '@mui/icons-material/ArrowDownward';
import ArrowUpwardIcon from '@mui/icons-material/ArrowUpward';
import { formatNumber, percentageConverter } from '../../utils/format-numbers';
import { StyledTableCell, StyledTableContainer, StyledTableRow } from '../../../components/CoinTable';
            ...
            <StyledBox display='flex'>
                ...
                <StyledTableContainer component={Paper}>
                    <Table aria-label="coins table">
                        ...
                        <TableBody>
                            <StyledTableRow>
                                <StyledTableCell>{percentageConverter(coinDetails.price_change_percentage_24h)}</StyledTableCell>
                                <StyledTableCell>{percentageConverter(coinDetails.price_change_percentage_7d)}</StyledTableCell>
                                <StyledTableCell>{percentageConverter(coinDetails.
                                    price_change_percentage_14d)}</StyledTableCell>
                                <StyledTableCell>{percentageConverter(coinDetails.
                                    price_change_percentage_30d)}</StyledTableCell>
                                <StyledTableCell>{percentageConverter(coinDetails.price_change_percentage_60d)}</StyledTableCell>
                                <StyledTableCell>{percentageConverter(coinDetails.price_change_percentage_200d)}</StyledTableCell>
                                <StyledTableCell>
